...
public class Game1 extends JComponent implements KeyListener, MouseMotionListener, MouseListener{
    ...
    BufferedImage turkey = loadImage("Turkey_strut (1).png");
    ...
    public void paintComponent(Graphics g)
    {
        ...
        g.drawImage(turkey,100, 500, 50, 50, null);
